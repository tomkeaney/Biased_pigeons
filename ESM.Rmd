...
Click **[here - hidden for blind review](XX)** to view the HTML report, which serves as online supplementary material for the associated manuscript ( _insert DOI_), in review at _Behavioural Ecology_. The report documents our empirical analysis (contains raw data and R-script) and provides all supplementary Figures and Tables.
