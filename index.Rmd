---
title: 'An undergraduate classroom experiment illustrates an effect of observer bias on data collection in animal behaviour'
...
**Table A1**. Posterior estimates of the percentage of pigeons foraging, split by the primer that students were allocated.
...
**Table A2**. Posterior estimates of the percentage of pigeons foraging, split by the actual expectation of the students.
...
**Figure A1**. the pigeons selected for baseline estimation of feeding rate.
...
baseline_data <- read.csv("data/baseline_peck_data.csv", sep = ";") %>% 
...
**Table A3**. The estimated peck rate of foraging pigeons, split by the primer students were allocated. Each student observed two pigeons.
...
**Table A4**. The estimated peck rate of foraging pigeons, split by the indicated expectation of the students. Each student observed two pigeons. 
...
**Table A5**. The degree to which each group of students overestimated feeding rate (number of ground pecks per minute)
