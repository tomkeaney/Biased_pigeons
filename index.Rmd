...
The `pigeon_video.mp4` file and priming emails sent to students are available in the `Teaching_resources` folder found on the github page associated with this manuscript. They can be accessed here: https://github.com/tomkeaney/Biased_pigeons.
